          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Display House Member</h4>
              </div>
              <div class="card-body">
                ...
                <form action="#" method="POST">
                  <table class="table">
                   ...
                   <tbody>
                       <?php
                        $query="select * from house_member where user_id=".$_SESSION['user'];
                        ...
                        while($row=mysqli_fetch_assoc($result)){
                         echo "<tr>";
                          ...
                          echo "</td>";
                          echo "<td>".$row['h_dob']."</td>";
                          echo "<td>".$row['h_blood']."</td>";
                          echo '<td><a href="edit_house_member.php?id='.$row['h_id'].'">
                          <button type="button" class="btn btn-success editbtn">
                          Edit</button></a></td>';
                         
                         echo '<td><a href="delete_house_member.php?id='.$row['h_id'].'">
